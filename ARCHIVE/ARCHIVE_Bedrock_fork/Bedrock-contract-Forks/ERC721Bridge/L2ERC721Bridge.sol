...
import {ERC721Bridge, CrossDomainMessenger} from "../../Bedrock-Universals-Forks/ERC721Bridge.sol";
import {ERC165Checker} from "@openzeppelin/contracts/utils/introspection/ERC165Checker.sol";
import {Semver} from "@eth-optimism/contracts-bedrock/contracts/universal/Semver.sol";
import {L1ERC721Bridge} from "./L1ERC721Bridge.sol";
import {IOptimismMintableERC721} from "@eth-optimism/contracts-bedrock/contracts/universal/IOptimismMintableERC721.sol";
...
contract L2ERC721Bridge is ERC721Bridge, Semver {
    ...
    function _initiateBridgeERC721(
        ...
        // slither-disable-next-line reentrancy-events
        (address crossDomMsger,,) = getAddresses(_targetChainID);
        CrossDomainMessenger(crossDomMsger).sendMessage(_targetChainID, OTHER_BRIDGE, message, _minGasLimit);
        // slither-disable-next-line reentrancy-events
