 ...
 */
abstract contract ERC721Bridge is OPAddressRegistry_Testnet {
    /**
     ...
     */
    function messenger(uint256 _targetChainID) external view returns (CrossDomainMessenger) {
        (address crossDomMsger,,) = getAddresses(_targetChainID);
        return CrossDomainMessenger(crossDomMsger);
    }
